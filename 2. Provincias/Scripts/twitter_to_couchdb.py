...
###API ########################
ckey = "hSXE4SZw6qbJ43NZaodmz1Sk1"
csecret = "1nPYTEEiwJBczXs0GKeP2iEDvThf0oAluRXnr2LWWl4NLQML1V"
atoken = "1631284146-ZN7DbDWQLJ9z76Bazba5TXKtwvwpwG1sSSfQUD9"
asecret = "ZO2s8UtD3YOySFddY79gCCYZqc3nCUlYk3imFEX2uvlxz"
#####################################
...
try:
   #Nombre de la base de datos por provincia
    db = server.create('pulso_politico_provincias')
except:
    db = server['pulso_politico_provincias']
